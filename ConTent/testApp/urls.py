...
urlpatterns = [
    ...
    url(r'^reservation/new-reservation/(?P<id>\d+)$', views.newreservation, name='reservation'),
    ...
    url(r'^user/$', views.user, name='user-client-start'),
    ...
    url(r'^confirm-reservation/', views.confirm_reservation, name='confirm-reservation')
]
